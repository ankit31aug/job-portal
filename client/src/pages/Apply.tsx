...
export default function Apply() {
  ...
  if (submitted) return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-4">
      <div className="card p-10 text-center max-w-md">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-2">Your application for <strong>{job?.title}</strong> at <strong>{job?.company}</strong> has been submitted successfully.</p>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">The employer will review your profile and get back to you.</p>
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <Link to={`/jobs/${jobId}`} className="inline-flex items-center gap-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 mb-6 text-sm">
      ...
      {job && (
        <div className="card p-4 mb-6 flex items-center gap-4">
          ...
          <span className="ml-auto badge bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300">{job.job_type}</span>
        </div>
      )}

      <div className="card p-6">
        <h1 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Apply for this Position</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Upload your PDF resume to auto-fill the form, then review and submit.</p>
